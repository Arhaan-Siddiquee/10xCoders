  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-80 bg-gray-800 p-6 flex flex-col justify-between">
        ...
        {/* Language Selection */}
        <div className="mt-4">
          <h3 className="text-white text-lg mb-2">Select Language</h3>
          <div className="flex space-x-2">
            <button
              onClick={() => handleLanguageChange("en-US")}
              className={`px-4 py-2 rounded-md ${activeLanguage === "en-US" ? "bg-orange-500" : "bg-gray-700"} text-white`}
            >
              English
            </button>
            <button
              onClick={() => handleLanguageChange("hi-IN")}
              className={`px-4 py-2 rounded-md ${activeLanguage === "hi-IN" ? "bg-orange-500" : "bg-gray-700"} text-white`}
            >
              Hindi
            </button>
            <button
              onClick={() => handleLanguageChange("ta-IN")}
              className={`px-4 py-2 rounded-md ${activeLanguage === "ta-IN" ? "bg-orange-500" : "bg-gray-700"} text-white`}
            >
              Tamil
            </button>
          </div>
